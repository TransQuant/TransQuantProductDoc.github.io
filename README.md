...
* 因子库/策略库
对于项目内的因子或策略，在运行因子检验或策略回测后，因子/策略将以表格形式汇总至因子库/策略库中。  
表格便捷的支持了搜索、排序、筛选等功能，可以对策略或因子进行筛选。  
![](./interface_intro/个人因子库.jpg)
![](./interface_intro/个人策略库.jpg)
...
* 因子库/策略库
对于团队内的因子或策略，在运行因子检验或策略回测后，因子/策略将以表格形式汇总至因子库/策略库中。  
表格便捷的支持了搜索、排序、筛选等功能，可以对策略或因子进行筛选。可以将表格导出为excel。  
![](./interface_intro/团队因子库.jpg)  
![](./interface_intro/团队策略库.jpg)  
...
1. 增加个人因子面板，汇总个人项目里各因子情况，用户可更方便了解个人的因子开发进度及因子整体情况
2. 增加个人策略面板，汇总个人项目里各策略情况，用户可更方便了解个人的策略开发进度及策略整体情况。
3. 增加团队因子面板，团队因子表现汇总界面，可更方便了解团队的因子开发进度及开发情况。
4. 增加团队策略面板，团队策略表现汇总界面，可更方便了解团队的策略开发进度及开发情况。
5. 回测结果页面优化，回测结果图形化展示页面优化，增加右侧导航栏，方便用户快速跳转至相应图表
6. 数据资源页面优化，数据资源页面优化，数据资源表详情页增加数据样例，用户可更快了解表内数据情况
